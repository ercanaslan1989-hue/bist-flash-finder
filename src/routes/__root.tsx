...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BIST Signal Research Lab" },
      {
        name: "description",
        content:
          "Research which signals appear before BIST stocks make large moves or hit limit-up. Data collection and pattern statistics — not trading signals.",
      },
      { name: "author", content: "BIST Signal Research Lab" },
      { property: "og:title", content: "BIST Signal Research Lab" },
      {
        property: "og:description",
        content: "Discover the highest-probability setups that appear before large BIST price moves.",
      },
